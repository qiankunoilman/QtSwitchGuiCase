...
QT_MOC_LITERAL(1, 13, 17), // "CustomClickSignal"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5) // "index"

    },
    "CustomButton\0CustomClickSignal\0\0index"
};
...
void CustomButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CustomClickSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomButton::CustomClickSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomButton::CustomClickSignal(int _t1)
{
